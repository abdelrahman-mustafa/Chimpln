...
public class UserProfileEventsTabHistory extends android.support.v4.app.Fragment implements FirebaseEventsListener {
    ...
    public void onReadDataResponse(DataSnapshot dataSnapshot) {
        ...
        if (dataSnapshot != null) {
            ...
            for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                ...
                if (eventModel != null && eventModel.getBookerUserId() != null && eventModel.getBookerUserId().equals(FirebaseAuth.getInstance().getCurrentUser().getUid()) && eventModel.getEventStatus() != null && eventModel.getEventStatus().equals("finished")) {
