...
public class Usere_photographer_Events extends Fragment {
    ...
    public Usere_photographer_Events() {
    ...
    public static Usere_photographer_Events newInstance(String param1, String param2) {
        Usere_photographer_Events fragment = new Usere_photographer_Events();
