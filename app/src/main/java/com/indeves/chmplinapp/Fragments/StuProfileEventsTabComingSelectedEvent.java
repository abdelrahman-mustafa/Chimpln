...
public class StuProfileEventsTabComingSelectedEvent extends android.support.v4.app.Fragment  implements View.OnClickListener, FirebaseEventsListener{
    ...
    @SuppressLint("ValidFragment")
    public StuProfileEventsTabComingSelectedEvent(EventModel eventModel) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_stu_upcoming_event_selected, container, false);
