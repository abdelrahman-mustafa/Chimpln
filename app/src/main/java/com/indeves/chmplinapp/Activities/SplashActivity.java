    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                SharedPreferences shre = PreferenceManager.getDefaultSharedPreferences(SplashActivity.this);
                if (shre.getBoolean("proToServ", false)) {
                    startActivity(new Intent(SplashActivity.this, RespondToServerActivity.class));
                    SplashActivity.this.finish();
                } else if (shre.getBoolean("proReg", false)) {
                    startActivity(new Intent(SplashActivity.this, ProRegActivity.class));
                    SplashActivity.this.finish();
                } else {
